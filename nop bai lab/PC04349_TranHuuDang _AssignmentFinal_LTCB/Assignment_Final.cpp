		...
		if (gioBatDau<12 || gioKetThuc>23 || gioBatDau > gioKetThuc) {
			...
			// neu qua 3h dau thi khuyen mai 30%/h 
				if (soGio>3) {
					...
					printf("\t[So gio da vuot qua 3h dau tien]\n");
...
void bai5 () {
	...
	do {
			...
			soTienBanDau=soTien;
			if (soTien>0) {
				printf("Voi "); printf("%dK ",soTienBanDau); 
		...
		printf("\n");
			...
			for(int i=1;i<=thang;i++){
				tienLai=tienConLai*laiSuatThang; 
		     	...
		     	printf("-------------------------------------------------------------------------------\n");
		     	printf("|");printf(" %6d  ",i); 
		     	printf("|"); printf(" %12d  ",tienLai); 
		     	printf("| "); printf("%12d  ",tienGoc); 
				printf("| ");printf("%12d      ",tienTra);
				printf("| ");printf("%12d    ",tienConLai);  printf("| ");
				printf("\n");
			}
				printf("+-------------------------------------------------------------------------------+\n");		
		}
